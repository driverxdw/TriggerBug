...
static inline Z3_ast Reg2Ast(Char nbytes, UChar* m_bytes, UChar *m_fastindex, Z3_ast* m_ast, Z3_context ctx) {
...
public:
    ...
    inline Register(const Register<maxlength> &father_regs) { vassert(0); };
    inline void operator = (Register<maxlength> &a) { vassert(0); };
